...
public class UserServiceImpl implements UserService {
	...
	public void write(UserDTO userDTO) {
		...
		//똑같은 아이디가 없으면 insert가 수행이 되고, 아이디가 있으면 update로 수행된다.
	...
	public String isExistId(String id) {
		...
		Optional<UserDTO> userDTO = userDAO.findById(id);//id가 없으면 Optional.empty 출력
...
JPQL은 일반적인 SQL과 유사한 문법을 가지고 있지만 검색 대상이 테이블이 아니라 영속성 컨텍스트(DTO 객체가 와야함)에 등록된 엔티티이다.
